<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <form wire:submit.prevent="update" class="form-sample">
                <input type="hidden" wire:model="peminjamId">
                ...
                <button type="submit" class="btn btn-primary mr-2" wire:click="update()">Submit</button>
            </form>
        </div>
